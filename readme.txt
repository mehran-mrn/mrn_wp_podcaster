...
* Add buffering feedback and enlarge the minimize and close controls.
* Replace the progress container with a thin edge-aligned seek line.
* Prevent the custom speed control from overlapping neighboring controls.

= 0.2.0 =
* Add first-class public Castbox comment discovery and moderation import.
* Redesign listener comments as a one-card carousel.
* Polish progress, transport, speed and close controls and remove downloads.
